					  ...
					  <div class="cat_widg">
						   <a href="<?php the_permalink(); ?>">	
							  <div class="cat_widg-img">
								 <?php echo news_magazine_display_thumbnail(140,130);  ?>
							  </div>
						  </a>	  
						  <p>
							  <?php  echo news_magazine_the_excerpt_max_charlength(90);  ?>
						  </p>	
					  </div>
