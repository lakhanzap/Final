...
{
    function news_magazine_events_categ(){
		$widget_ops = array('description' => 'Displays Events Categories Posts');
		$control_ops = array('width' => '', 'height' => '');
		parent::WP_Widget(false,$name='Events Categories Posts',$widget_ops,$control_ops);
	}
			    	...
			    	<div class="events">
					  <div class="events-widg">	
					     <a class="title_href" href="<?php echo get_permalink() ?>">
							<span class="date">
								<span class="events-day"><?php the_time('d'); ?></span><br> 
								<span class="events-month"><?php the_time('M'); ?></span>
							</span>
						 </a>	
						 <p>
							<?php  echo news_magazine_the_excerpt_max_charlength(100);  ?>
						 </p>						     
					  </div>
