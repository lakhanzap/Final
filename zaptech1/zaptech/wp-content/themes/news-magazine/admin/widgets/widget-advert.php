<?php 
class news_magazine_adv extends WP_Widget
{
    function news_magazine_adv(){
		$widget_ops = array('description' => 'Displays Advertisments');
		$control_ops = array('width' => 400, 'height' => 500);
		parent::WP_Widget(false,$name='Advertisment',$widget_ops,$control_ops);
	}
...
<?php if ($bannerTitle[$key] == '') $bannerTitle[$key] = "advertisement";
	...
	<a href="<?php echo esc_url($bannerUrl[$key]); ?>" ><img src="<?php echo $bannerPath[$key]; ?>" alt="<?php echo $bannerAlt[$key]; ?>" title="<?php echo $bannerTitle[$key]; ?>" /></a>
<?php };
					}
echo $after_widget;
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
			...
			$instance = wp_parse_args( (array) $instance, array('title'=>'Advertisment', 'bannerPath'=>'', 'bannerUrl'=>'', 'bannerTitle'=>'', 'bannerAlt'=>'') );
...
}// end news_magazine_adv class
add_action('widgets_init', create_function('', 'return register_widget("news_magazine_adv");'))
?>