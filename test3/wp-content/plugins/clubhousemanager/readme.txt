...
To use in a page, use the following shortcodes in the content of your page:
     [club_topbatters team=teamname season=seasonname] - Top Batters*
     [club_toppitchers team=teamname season=seasonname] - Top Pitchers*
     [club_lastgame] - Last Game
     [club_nextgame] - Next Game
     [club_batstats team=teamname season=seasonname] - Batting Stats*
     [club_roster team=teamname season=seasonname] - Roster*
     [club_pitchstats team=teamname season=seasonname] - Pitching Stats*
     [club_fieldstats team=teamname season=seasonname] - Fielding Stats*
     [club_playerstats] - Player Stats
     [club_schedule team=teamname season=seasonname] - Schedule*
...
- REMOVED: Deleted admin_bbnuke user.  This account was only needed in early versions of club and is no longer needed.
- RETIRED: Top 5 stats widget. 
- RETIRED: Gamechanger import

= 1.2.1 =
- BUG FIX: new database column for game status was not added to existing club installations that were upgrading causing issues with the schedule widget.
